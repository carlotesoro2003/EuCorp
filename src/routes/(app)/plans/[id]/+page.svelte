	...
	{:else}
		<div class="flex flex-col gap-6">
			...
			{#if objectives.length > 0}
				...
				<!-- Add after the main table, before any pagination -->
<div class="mt-4 p-4 bg-card rounded-lg shadow border border-border">
    <h3 class="text-sm font-semibold mb-2">Action Plan Status Legends:</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {#if userRole === "admin"}
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-muted-foreground">Pending Admin Review</span>
            </div>
        {/if}
        ...
        {#if userRole === "vice_president"}
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-muted-foreground">Pending VP Review</span>
            </div>
        {/if}
        ...
        {#if userRole === "president"}
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-muted-foreground">Pending President Review</span>
            </div>
        {/if}
    </div>
</div>
