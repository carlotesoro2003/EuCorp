...
export declare const dispatchMenuOpen: (element: HTMLElement, detail?: unknown) => void, listenMenuOpen: (element: EventTarget, callback: (event: CustomEvent<unknown>) => void) => VoidFunction;
