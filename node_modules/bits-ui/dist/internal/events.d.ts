 ...
 */
export declare function createCustomEvent<T = unknown>(eventName: string, options?: Omit<CustomEventInit<T>, "detail">): readonly [(element: HTMLElement, detail?: T) => void, (element: EventTarget, callback: (event: CustomEvent<T>) => void) => VoidFunction];
export {};
