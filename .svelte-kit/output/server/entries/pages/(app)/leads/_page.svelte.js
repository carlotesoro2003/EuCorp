import { N as spread_props, O as slot, P as sanitize_props, A as push, E as escape_html, J as attr, C as pop, Q as ensure_array_like } from "../../../../chunks/index.js";
...
function Table($$payload, $$props) {
  ...
  if (showForm) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50"><div class="bg-card p-6 rounded-lg w-full max-w-md relative border border-border"><button class="absolute right-4 top-4 p-1 hover:bg-muted rounded-lg">`;
    X($$payload, { size: 20 });
    $$payload.out += `<!----></button> `;
    LeadForm($$payload, {
      lead: editingLead,
