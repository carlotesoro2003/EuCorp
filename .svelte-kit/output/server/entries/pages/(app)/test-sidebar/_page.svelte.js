import { Z as once, A as push, $ as spread_attributes, K as bind_props, C as pop, S as copy_payload, T as assign_payload, N as spread_props, R as stringify, O as slot, P as sanitize_props, J as attr, Q as ensure_array_like, E as escape_html, F as store_get, G as unsubscribe_stores } from "../../../../chunks/index.js";
                  ...
                  Group($$payload5, {
                    children: ($$payload6) => {
                      Dropdown_menu_item($$payload6, {
                        ...
                        children: ($$payload7) => {
                          Circle_user($$payload7, {});
                          $$payload7.out += `<!----> Profile`;
                        },
                        $$slots: { default: true }
                      });
                    },
