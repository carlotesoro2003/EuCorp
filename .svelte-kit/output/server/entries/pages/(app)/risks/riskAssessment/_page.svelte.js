import { E as escape_html, S as copy_payload, T as assign_payload, C as pop, A as push } from "../../../../../chunks/index.js";
...
function Header($$payload, $$props) {
  ...
  $$payload.out += `<header><div class="container mx-auto px-4 py-6"><h1 class="text-3xl font-bold text-gray-900 dark:text-white">${escape_html(departmentName)} Risk Register</h1> <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Manage and assess department risks</p></div></header>`;
}
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<!----> Back</a> <div class="min-h-screen">`;
