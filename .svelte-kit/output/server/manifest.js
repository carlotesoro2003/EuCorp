	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/(app)/api/evaluate-goal/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/(app)/api/summary-report-opt-monitoring/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/(app)/api/summary-report-plan-monitoring/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/(app)/auth/callback/_server.ts.js'))
			},
			{
